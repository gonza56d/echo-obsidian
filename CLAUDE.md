...
- **Everything clickable, as short text, in the BODY**: every PR, Azure
  ...
  - Notion PRD: `https://app.notion.com/p/<32-hex-page-id>` — link the PRD
    TITLE as display text; resolve the full page id via Notion search if
    only a truncated id is known.

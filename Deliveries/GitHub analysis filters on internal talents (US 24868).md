...
- Did NOT touch the `pending` writer in `service.py:1090` to use the new enum — stayed in scope; possible nit for review.
...
## Pending
- Team review + merge of [#2247](https://github.com/taller-projects/echo-backend/pull/2247); dev + kforce-dev deploy.

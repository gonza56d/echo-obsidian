...
**Status**: PR open, review r1 done (nits fixed `1f49c00e`) · **Ticket**: [Bug 25021](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/25021) (In revision) · **PR**: https://github.com/taller-projects/echo-backend/pull/2302 (→ dev)
...
- [ ] PR #2302 merge to dev; verify dev DB converged (expect 1 `Referral` row, 1852 talents)

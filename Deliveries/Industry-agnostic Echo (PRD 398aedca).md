...
- [#1834](https://github.com/taller-projects/echo-backend/pull/1834) **M5** (Task 23576, 2026-07-14) — **generic seniority ladder** for non-tech tenants.
- [#1835](https://github.com/taller-projects/echo-backend/pull/1835) (23583, 2026-07-14) — expose resolved `industry` on `/users/me` (FE's permission oracle — additive).
...
## Client context
- First consumer: **Battle Tested** (veteran-staffing client, Epic 23300: career page, Hiring our Heroes scrape, API key). "Enabled Force" = possible 2nd brand, unconfirmed.

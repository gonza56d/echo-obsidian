...
## PRs
- [#2043](https://github.com/taller-projects/echo-backend/pull/2043) → dev — **OPEN** (2026-08-11)
...
- Tests: unit `test_file_validation.py` (accepted csv/json incl. whitespace/empty; forged `.json` HTML/SVG/EXE/BOM rejected; json rejected on document/resume to pin scope) → 52 pass. System `test_blob_upload_validation.py` parametrized over png/csv/json 201 + forged-json 400 → 6 pass.

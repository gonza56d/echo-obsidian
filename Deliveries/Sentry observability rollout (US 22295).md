...
## Azure / docs
- [US 22295](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/22295) — Sentry observability (echo-backend slice; sibling stories [22296](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/22296)/97/98 for other services were left pending)
- [Ticket 23141](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/23141) — dispatcher errors to Sentry
- Sentry org: `taller-wn` (token in `~/.zshrc`, `/sentry` skill)

## PRs (all → dev, merged 2026-06-19)
- [#1578](https://github.com/taller-projects/echo-backend/pull/1578) — send outbox **dispatcher** errors to Sentry ([23141](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/23141))
...
- [#1590](https://github.com/taller-projects/echo-backend/pull/1590) — review follow-ups consolidated into ONE PR ([#1583](https://github.com/taller-projects/echo-backend/pull/1583)/[#1587](https://github.com/taller-projects/echo-backend/pull/1587) closed in its favor — see the "single PR for related nits" rule)

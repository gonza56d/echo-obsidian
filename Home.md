...
- [[Open Jobs 1-5 matching (US 23640)]] — **M1 (backend) PR [#1854](https://github.com/taller-projects/echo-backend/pull/1854) open → `dev`, review round 1 fixed** (tasks 23641/42/43 in one PR; built vs mock; **merge gated on Data endpoint [US 23610](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/23610)**). M2 (FE, [US 23644](https://dev.azure.com/TallerInternTools/Echo%20Core/_workitems/edit/23644)) is frontend-owned (not backend scope) — its PR should note M1 must merge first.
